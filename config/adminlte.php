    ...
    */
    ...
    'submenu' => [
        [
            ...
            'url'  => 'guru/indikator-aqidah',
            'can'  => 'guru', 
        ],
        [
            'text' => 'Ibadah',
            'icon' => 'far fa-fw fa-circle',
            'url'  => 'guru/indikator-ibadah', 
            'can'  => 'guru',
        ],
        [
            'text' => 'Akhlaq',
            'icon' => 'far fa-fw fa-circle',
            'url'  => 'guru/indikator-akhlaq', 
            'can'  => 'guru',
        ],
        [
            'text' => 'Disiplin dan Kendali diri',
            'icon' => 'far fa-fw fa-circle',
            'url'  => 'guru/indikator-disiplin', 
            'can'  => 'guru',
        ],
        [
            'text' => 'Al-Quran',
            'icon' => 'far fa-fw fa-circle',
            'url'  => 'guru/indikator-al-quran', 
            'can'  => 'guru',
        ],
        [
            'text' => 'Wawasan Keagamaan',
            'icon' => 'far fa-fw fa-circle',
            'url'  => 'guru/indikator-keagamaan',
            'can'  => 'guru', 
        ],
        [
            'text' => 'Kesehatan Kebugaran',
            'icon' => 'far fa-fw fa-circle',
            'url'  => 'guru/indikator-kesehatan-kebugaran', 
            'can'  => 'guru',
        ],
        [
            'text' => 'Life Skill dan Wirausaha',
            'icon' => 'far fa-fw fa-circle',
            'url'  => 'guru/indikator-life-skill', 
            'can'  => 'guru',
        ],
    ],
],
    ...
    [
        ...
        'submenu' => [
            [
                'text' => 'Kondisi Tubuh',
                'icon' => "fas fa-user",
                'url' => 'guru/kondisi-tubuh',
                'can'    => 'guru',
            ],
            [
                'text' => 'Kebersihan Siswa', 
                'url' => 'guru/kebersihan-siswa',
    ...
    'submenu' => [
        [
            'text' => 'Aqidah',
            'icon' => 'far fa-fw fa-circle',
            'url'  => 'guru/hasil-capaian/aqidah', 
            'can'    => 'guru',
        ],
        [
            'text' => 'Ibadah',
            'icon' => 'far fa-fw fa-circle',
            'url'  => 'guru/hasil-capaian/ibadah', 
            'can'    => 'guru',
        ],
        [
            'text' => 'Akhlaq',
            'icon' => 'far fa-fw fa-circle',
            'url'  => 'guru/hasil-capaian/akhlaq', 
            'can'    => 'guru',
        ],
        [
            'text' => 'Disiplin',
            'icon' => 'far fa-fw fa-circle',
            'url'  => 'guru/hasil-capaian/disiplin', 
            'can'    => 'guru',
        ],
        [
            'text' => 'Al-Quran',
            'icon' => 'far fa-fw fa-circle',
            'url'  => 'guru/hasil-capaian/al-quran', 
            'can'    => 'guru',
        ],
        [
            'text' => 'Keagamaan',
            'icon' => 'far fa-fw fa-circle',
            'url'  => 'guru/hasil-capaian/keagamaan', 
            'can'    => 'guru',
        ],
        [
            'text' => 'Kesehatan & Kebugaran',
            'icon' => 'far fa-fw fa-circle',
            'url'  => 'guru/hasil-capaian/kesehatan-kebugaran', 
            'can'    => 'guru',
        ],
        [
            'text' => 'Life Skill',
            'icon' => 'far fa-fw fa-circle',
            'url'  => 'guru/hasil-capaian/life-skill', 
            'can'    => 'guru',
        ],
    ],
],
