...
@section('title', 'Kesehatan Mulut')

@section('content_header')
<div class="d-flex justify-content-between align-items-center">
    <h1 class="m-0 font-weight-bold">Kesehatan Mulut</h1>
    <ol class="breadcrumb float-sm-right">
        <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
        <li class="breadcrumb-item active">Kesehatan Mulut</li>
    </ol>
</div>
@stop
        ...
        <div class="card shadow-sm border-0 mb-5">
            <div class="card-header bg-white py-3 px-4">
                <h5 class="card-title fw-bold mb-1">
                    <i class="fas fa-smile-beam mr-2"></i> Input Kesehatan Mulut Siswa
                </h5>
            </div>
                    ...
                    <table class="table table-bordered table-hover align-middle mb-0">
                        <thead class="text-white text-center" style="background-color:#17a2b8;">
                            <tr>
                                ...
                                <th style="width:15%;">Kondisi Mulut</th>
                                <th style="width:20%;">Keterangan</th>
                            </tr>
                        </thead>
                        <tbody>
                        @forelse($kesehatanMuluts as $item)
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="keterangan[]" value="{{ $item->kesehatanMulut->keterangan ?? '' }}" class="form-control">
                                </td>
                            </tr>
                        @empty
                            <tr>
