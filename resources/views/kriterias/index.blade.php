                                    ...
                                    <form action="{{ route('kriteria.update', $item->id) }}" method="POST">
                                        ...
                                        <div class="modal-body p-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="kriteria" class="form-control rounded-3"
                                                    value="{{ $item->kriteria }}" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label fw-bold">Deskripsi</label>
                                                <input type="text" name="deskripsi" class="form-control rounded-3"
                                                    value="{{ $item->deskripsi }}" required>
                                            </div>
                                        </div>
                                        <div class="modal-footer border-0 pb-4 px-4">
                                            <button type="button" class="btn btn-light py-2 px-4 fw-bold"
                                                data-bs-dismiss="modal" style="border-radius: 12px;">Kembali</button>
                                            <button type="submit" class="btn btn-dark flex-grow-1 py-2 fw-bold"
                                                style="border-radius: 12px;">Simpan Perubahan</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                    ...
                    <div class="modal-body p-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="kriteria" class="form-control" placeholder="Masukkan kriteria..."
                                style="border-radius: 14px; padding: 12px;" required>

                            <label class="form-label fw-bold mt-3">Deskripsi</label>
                            <textarea name="deskripsi" class="form-control" rows="3" placeholder="Masukkan deskripsi kriteria..."
                                style="border-radius: 14px; padding: 12px;"></textarea>
                        </div>
                    </div>
                    <div class="modal-footer border-0 pb-4 px-4">
